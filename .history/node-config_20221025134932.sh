...
# In PRD we would like to have 3 master nodes. For this we can create Load balancer in the VDC and configure DNAT to the LB. The public IP will have an A-record